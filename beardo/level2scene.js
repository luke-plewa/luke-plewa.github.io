...
Level2Scene = Class.create(Scene, {
    initialize: function() {
        Scene.apply(this);
        ...
        // Add temp enemy
        /*enemy = new Enemy(ENEMY_WIDTH, ENEMY_HEIGHT);
        enemy.x = stgWidth*0.9;
        enemy.y = stgHeight*0.5;
        //this.addChild(enemy);

        //enemyList.push(enemy);
        //enemyList.push(enemy2);

        enemy2 = new Enemy2(ENEMY_WIDTH2, ENEMY_HEIGHT2);
        enemy2.x = stgWidth*0.95;
        enemy2.y = stgHeight*0.5;
        ...
        this.level2music = new Audio('assets/sounds/level2.mp3');
    ...
    levelUpdate: function()
    {
	    ...
	    if (accumulator == 400) {
            ...
            health = HEALTH_MAX;
            postLevel2Scene = new PostLevel2Scene();
    	    game.replaceScene(postLevel2Scene);
	    }
    }
});